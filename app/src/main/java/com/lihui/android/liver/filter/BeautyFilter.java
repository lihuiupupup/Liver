...
import com.lihui.android.liver.activity.MainActivity;
...
public class BeautyFilter extends BaseFilter{
    private static final String TAG = "NoFilter";
    ...
    private final String fragmentShaderCode = MainActivity.beautyFragmentCode;
...
//        GLES20.glClearColor(0, 0, 0, 1);
        ...
        int singleStepOffsetLocation = GLES20.glGetUniformLocation(mProgram, "singleStepOffset");
        GLES20.glUniform2fv(singleStepOffsetLocation, 1, new float[]{2.0f / width, 2.0f / height}, 0);
    ...
    public BeautyFilter(int textureID,int width,int height) {
